...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		p2.getCategorias().addAll(Arrays.asList(cat1 , cat2, cat4));		//Instanciando lista de categorias
		...
		produtoRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11));		//Instanciando salva a lista de produtos
